class Player {
    ...
    equipWeapon(){
        ...
        let url = "images_2/Players/" + this.name + "_" + this.equippedWeapon.name + ".png";
...
function drawPlayer() {
    player1 = new Player ("Thor",100,"images_2/Players/player1.png",false);
    player1.setPositionPlayer1();
    $('#'+ player1.playerId ).addClass('player1');
    players.push(player1); 
    player2 = new Player ("Odin",100,"images_2/Players/player2.png",false);
